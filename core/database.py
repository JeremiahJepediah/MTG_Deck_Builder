...
class Database:
    ...
    def init_database(self):
        ...
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_card_type ON cards(type)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_card_colors ON cards(colors)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_card_owned ON cards(owned)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_card_set ON cards(set_code)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_card_rarity ON cards(rarity)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_image_id ON cards(image_id)')
        ...
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_tag ON card_tags(tag)')
        ...
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_deck_cards ON deck_cards(deck_id, card_id)')
